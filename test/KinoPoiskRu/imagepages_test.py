...
class ImagePagesTest(U.PageTest):
  ...
  def remoteTest_fetchAndParsePostersData_more(self):
    ...
    posters = data['posters']
    self.assertIsNotNone(posters, 'posters data is present.')
    self._assertEquals(2, len(posters), 'Wrong number of posters parsed.')
    self.assertThumbnail(posters[0], 0, 89,
      'http://st.kinopoisk.ru/images/film_big/42782.jpg',
      'http://st.kinopoisk.ru/images/film_big/42782.jpg',
      780, 1024)
    self.assertThumbnail(posters[1], 1, 40,
      'http://st.kinopoisk.ru/images/poster/sm_2054233.jpg',
